...
class App extends React.Component {
  ...
  render(){
    ...
    let drpCont = mobile? 'uk-accordion-content' : 'uk-navbar-dropdown';
    let drpNav = mobile? '':'uk-nav uk-navbar-dropdown-nav';
    let navGen = mobile? '': 'links uk-navbar-nav';
    let parent = mobile? 'uk-open' : 'uk-parent';
    let acc = mobile? 'uk-accordion-title':'';
    
    
    return (
      <div className="App">
      <BrowserRouter>
      <nav  className="uk-navbar uk-navbar-container uk-margin" uk-navbar="mode: hover">
          ...
          <div id={offCanvas} uk-offcanvas={bool}>
              <div  className={navBar}>
                ...
                <ul className={navGen}>
                  ...
                  <li className="list-mem"><Link to="/about">Kompanija</Link></li>
